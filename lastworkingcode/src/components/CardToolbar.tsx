...
export const CardToolbar = ({
  ...
  return (
    ...
    >
      <button
        onClick={!isBeingEdited ? handleClick(() => onAddTodo()) : undefined}
      ...
      <button
        onClick={!isBeingEdited ? handleClick(() => {
      ...
      {isModal && (
        <button
          onClick={!isBeingEdited && hasUnsavedChanges ? handleClick(() => onSave()) : undefined}
