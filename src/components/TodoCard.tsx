      ...
      >
        ...
        >
          ...
          <div className="space-y-1 flex-1">
            {todos.map((todo) => (
              <div key={todo.id} className="flex items-center gap-2 w-full">
                <input
                  type="checkbox"
                  className="flex-shrink-0 w-3 h-3 border-2 border-[#3D3D3D] rounded-sm"
                  readOnly
                />
                <input
                  type="text"
          ...
          <div className="mt-3 grid grid-cols-9 gap-2">
            ...
            {/* Placeholder icons */}
            <div className="text-xs text-zinc-500 justify-self-center">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
            ...
            <button className="text-zinc-400 p-1 rounded justify-self-center">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
      ...
      >
        ...
        <div className="mt-3 grid grid-cols-9 gap-2" role="toolbar">
          ...
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 16 16">
              <g clipPath="url(#clip0_25_24)">
                <path
                  d="M5.33331 7C5.33331 7.55227 4.8856 8 4.33331 8C3.78103 8 3.33331 7.55227 3.33331 7C3.33331 6.44771 3.78103 6 4.33331 6C4.8856 6 5.33331 6.44771 5.33331 7Z"
                  fill="#3D3D3D"
                />
                <path
                  d="M7 5.33334C7.55227 5.33334 8 4.88563 8 4.33334C8 3.78106 7.55227 3.33334 7 3.33334C6.44771 3.33334 6 3.78106 6 4.33334C6 4.88563 6.44771 5.33334 7 5.33334Z"
                  fill="#3D3D3D"
                />
                <path
                  d="M11.3333 4.33334C11.3333 4.88563 10.8856 5.33334 10.3333 5.33334C9.78105 5.33334 9.33331 4.88563 9.33331 4.33334C9.33331 3.78106 9.78105 3.33334 10.3333 3.33334C10.8856 3.33334 11.3333 3.78106 11.3333 4.33334Z"
                  fill="#3D3D3D"
                />
                <path
                  d="M5 11.3333C5.55229 11.3333 6 10.8856 6 10.3333C6 9.78108 5.55229 9.33334 5 9.33334C4.44771 9.33334 4 9.78108 4 10.3333C4 10.8856 4.44771 11.3333 5 11.3333Z"
                  fill="#3D3D3D"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M0.666687 7.99999C0.666687 3.9499 3.94993 0.666656 8.00002 0.666656C11.9808 0.666656 15.3334 3.56613 15.3334 7.33332V7.34306C15.3334 7.69532 15.3334 8.29719 15.1217 8.99912C14.5668 10.8383 12.5469 11.3309 10.9966 10.9349C10.674 10.8525 10.3496 10.7633 10.0379 10.6738C9.50082 10.5194 9.01182 10.9931 9.11075 11.4877L9.32249 12.5465L9.39889 13.0045C9.59689 14.1927 8.66795 15.401 7.34435 15.2332C5.10015 14.9487 3.41323 14.0671 2.29065 12.7553C1.1715 11.4473 0.666687 9.77419 0.666687 7.99999ZM8.00002 1.99999C4.68631 1.99999 2.00002 4.68628 2.00002 7.99999C2.00002 9.52359 2.43117 10.8687 3.30372 11.8884C4.17285 12.9041 5.53335 13.6596 7.51209 13.9105C7.82315 13.9499 8.15655 13.661 8.08369 13.2237L8.01089 12.7869L7.80329 11.7491C7.49782 10.2217 8.96155 8.97712 10.4062 9.39232C10.708 9.47906 11.0194 9.56459 11.3265 9.64306C12.5172 9.94719 13.583 9.48326 13.8452 8.61399C13.998 8.10732 14 7.67059 14 7.33332C14 4.43385 11.383 1.99999 8.00002 1.99999Z"
                  fill="#3D3D3D"
                />
              </g>
              <defs>
          ...
          <button
            ...
            disabled={isModal && !hasUnsavedChanges}
          >
            {isModal ? 'Save' : 'Close'}
          </button>
